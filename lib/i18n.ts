...
const resources = {
  es: {
    translation: {
      ...
      "projects.hidalgo.shot4": "Ficha de libro con ISBN, número de páginas, tipo de portada y existencia por sucursal.",
      "projects.hidalgo.shot5": "Programa de lealtad de tres niveles, con cashback y beneficios que se desbloquean por compras.",
      "projects.eskani.shot4": "Menú de accesibilidad: temas claro, oscuro y de alto contraste, y ajuste de tamaño, espaciado e interlineado.",
      "projects.eskani.shot5": "Opciones de accesibilidad avanzadas: ocultar imágenes y tipografía optimizada para dislexia.",
      "projects.bookitech.shot3": "Preguntas frecuentes sobre listas escolares, pagos, entregas y facturación.",
      "projects.bookitech.shot4": "Selector de institución: cada colegio tiene su propio catálogo y sus listas. Los datos de los centros van ocultos.",
  ...
  en: {
    translation: {
      ...
      "projects.hidalgo.shot4": "Book page with ISBN, page count, cover type and stock by branch.",
      "projects.hidalgo.shot5": "Three-tier loyalty programme, with cashback and benefits unlocked by purchases.",
      "projects.eskani.shot4": "Accessibility menu: light, dark and high-contrast themes, plus font size, letter spacing and line height.",
      "projects.eskani.shot5": "Advanced accessibility options: hide images and a dyslexia-friendly typeface.",
      "projects.bookitech.shot3": "Frequently asked questions about school lists, payments, delivery and invoicing.",
      "projects.bookitech.shot4": "Institution picker: each school has its own catalogue and lists. School details are redacted.",
