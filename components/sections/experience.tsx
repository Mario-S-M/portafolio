...
const experiences = [
  {
    ...
    period: "2021 - 2025",
    description: "Formación integral en desarrollo de software, bases de datos, redes y sistemas distribuidos. Actualmente realizando residencias profesionales en ENES Morelia.",
    highlights: [
  ...
  },
  {
    ...
    location: "Morelia, Michoacán",
    period: "2025",
    description: "Desarrollo completo de plataforma web para la enseñanza de idiomas a personas con discapacidad visual, implementando tecnologías modernas y principios de accesibilidad.",
    highlights: [
  ...
  },
  {
    ...
    location: "Morelia, Michoacán",
    period: "2022",
    description: "Desarrollo de sistema de facturación conectando frontend con backend mediante servicios web, utilizando HTML, CSS y PHP para la integración y visualización de datos.",
    highlights: [
  ...
  },
  {
    ...
    location: "Morelia, Michoacán",
    period: "2024",
    description: "Desarrollo de plataforma educativa que utiliza inteligencia artificial para apoyar el aprendizaje de alumnos y profesores en el departamento de ciencias básicas.",
    highlights: [
  ...
  },
  {
    ...
    location: "Morelia, Michoacán",
    period: "2023",
    description: "Implementación de sistema completo para monitoreo y control de invernadero utilizando Arduino y protocolo MQTT para toma de temperaturas y gestión automatizada.",
    highlights: [
  ...
  },
  {
    ...
    location: "Morelia, Michoacán",
    period: "2023",
    description: "Desarrollo de sistema completo para gestión de ventas, inventario y proveedores para distribución de dispositivos móviles, incluyendo módulos de administración y reporting.",
    highlights: [
  ...
  },
  {
    ...
    description: "Desarrollo continuo de habilidades en tecnologías emergentes y mejores prácticas de desarrollo, con enfoque en la stack moderna de JavaScript/TypeScript y arquitectura de software.",
    highlights: [
    ...
    tech: ["React", "Next.js", "NestJS", "TypeScript", "Docker", "Kubernetes", "GraphQL"],
        ...
        <BlurFade delay={0.2}>
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Un recorrido por mi formación académica, proyectos destacados y crecimiento profesional
                  ...
                  <div className={`w-full md:w-1/2 ${
                    ...
                    <Card className="hover:shadow-xl transition-all duration-500 group">
                      <CardContent className="p-6">
                        ...
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex items-center space-x-3">
                            <div className={`p-2 rounded-lg bg-gradient-to-r ${experience.color}`}>
                              {experience.type === 'education' && <GraduationCap className="w-5 h-5 text-white" />}
                              {experience.type === 'project' && <Briefcase className="w-5 h-5 text-white" />}
                              {experience.type === 'learning' && <Briefcase className="w-5 h-5 text-white" />}
                            </div>
                            <div>
                              <span className={`text-xs font-medium px-2 py-1 rounded-full ${
                                ...
                                {experience.type === 'education' ? 'Educación' : 
                                 experience.type === 'project' ? 'Proyecto' : 'Aprendizaje'}
                              </span>
                            </div>
                          </div>
                        </div>
                        ...
                        {/* Highlights */}
                        <div className="mb-4">
                          <h4 className="font-semibold mb-2 text-sm">Logros destacados:</h4>
