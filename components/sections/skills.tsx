...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Spring Boot", level: 65, years: "1+" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "MongoDB", level: 60, years: "1+" },
      { name: "TypeORM", level: 65, years: "1+" },
    ],
  },
  {
    title: "DevOps & Cloud",
              ...
              <div className="relative">
                <IconCloud
                  images={[
                    ...
                    "https://cdn.simpleicons.org/apachemaven",
